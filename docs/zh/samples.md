...
CI 使用 Nuke `./build.cmd Ci`（仅控制台示例）。默认 NuGet 版本 **`0.1.0`**（[Events](https://www.nuget.org/packages/Observables.Events.R3/0.1.0)、[RestAPI](https://www.nuget.org/packages/Observables.RestAPI.R3/0.1.0)、[SignalR](https://www.nuget.org/packages/Observables.SignalR.R3/0.1.0)、[Mqtt](https://www.nuget.org/packages/Observables.Mqtt.R3/0.1.0)、[WebSocket](https://www.nuget.org/packages/Observables.WebSocket.R3/0.1.0)、[Grpc](https://www.nuget.org/packages/Observables.Grpc.R3/0.1.0)）。
