...
**`0.1.6`** is on [nuget.org](https://www.nuget.org/packages/Observables.Events.R3) (**16** meta-packages: Events, RestAPI, SignalR, Mqtt, WebSocket, Grpc, and Sse). Each feature ships two packages (R3 and System.Reactive):
