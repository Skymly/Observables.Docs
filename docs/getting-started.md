...
**`0.1.6-preview1`** is on [nuget.org](https://www.nuget.org/packages/Observables.Events.R3) (**16** meta-packages: Events, RestAPI, SignalR, Mqtt, WebSocket, Grpc, and Sse). Each feature ships two packages (R3 and System.Reactive):
...
```xml
<PackageReference Include="Observables.WebSocket.R3" Version="0.1.6-preview1" />
<PackageReference Include="R3" Version="1.3.0" />
```
...
```xml
<PackageReference Include="Observables.Sse.R3" Version="0.1.6-preview1" />
<PackageReference Include="R3" Version="1.3.0" />
```
