...
**`0.2.2`** is on [nuget.org](https://www.nuget.org/packages/Observables.Events.R3) (**20** meta-packages: Events, RestAPI, SignalR, Mqtt, WebSocket, Grpc, Sse, Nats, Postgres, and Redis). Each feature ships two packages (R3 and System.Reactive):
...
| `Observables.Postgres.Reactive` | Same → System.Reactive |
| `Observables.Redis.R3` | Redis Pub/Sub → R3 |
| `Observables.Redis.Reactive` | Same → System.Reactive |
...
```xml
<PackageReference Include="Observables.WebSocket.R3" Version="0.2.2" />
<PackageReference Include="R3" Version="1.3.0" />
```
...
```xml
<PackageReference Include="Observables.Sse.R3" Version="0.2.2" />
<PackageReference Include="R3" Version="1.3.0" />
```
