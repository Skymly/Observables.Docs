...
The NATS domain ships from **`0.1.0-preview8`** (same model as the other domains). Also reference [NATS.Client.Core](https://www.nuget.org/packages/NATS.Client.Core) and **R3** or **System.Reactive** in your app.
